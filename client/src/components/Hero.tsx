      ...
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        ...
        <div className="space-y-10">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-6">Satnam Singh Pahwa</h1>
            <h2 className="text-2xl text-primary font-medium">Data Engineer at JP Morgan Chase</h2>
          </div>
          
          <div className="prose dark:prose-invert text-gray-600 dark:text-gray-300 max-w-none text-lg">
            <p>
